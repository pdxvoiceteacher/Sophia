# PURPOSE: formal prior-use auditing is owned by Sophia
...
def audit_prior_use(packet: dict) -> dict:
    ...
    if mode == "ignore":
        ...
        if question_relevance_score < 0.02:
            mode_compliance = False
            audit_status = "warn"
    ...
    return {
        ...
        "recommendation": (
            "keep" if audit_status == "pass" else "review_prior_mode_or_retrieval_quality"
        ),
    }

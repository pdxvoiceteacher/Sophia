    ...
    try:
        ...
        for step in module_doc["steps"]:
            ...
            if stype == "ingest_json":
                ...
                # Disabled in this build for stability. Telemetry is produced by tools/telemetry/run_wrapper.py.
                raise ValueError(
                    "emit_telemetry_snapshot is disabled in this build; use run_wrapper telemetry.json instead."
                )
